...
plot.ProSpectSEDlike=function(x, xlim=c(1e2,1e10), ylim='auto',
  ...
  DustFlux$flux=convert_wave2freq(flux_wave=DustFlux$flux*.cgs_to_jansky, wave=DustFlux$wave)
